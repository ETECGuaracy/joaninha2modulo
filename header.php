	...
	<div id="header">
        ...
        <div id="menusup">
			...
			<div id="areaagendaonline">
				<label id="agendaonline"><a href="agendaOnline.php">Agenda OnLine</a> | <a href="lista.php">Lista de Materiais</a></label>
				<label id="alterarsenha"><a href="alterarSenha.php">Alterar senha</a></label>
			</div>
			<?PHP
			}else{
			?>
