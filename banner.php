<div id="bannerflash">
  <object id="FlashID" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="1024" height="209">
    ...
    <!--[if !IE]>-->
    <object type="application/x-shockwave-flash" data="menu/menu.swf" width="1024" height="209">
      <!--<![endif]-->
      <param name="quality" value="high">
      <param name="wmode" value="opaque">
      <param name="swfversion" value="9.0.45.0">
