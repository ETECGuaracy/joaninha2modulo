<?PHP
	Require('header.php');
?>
<p class="titulo">Instalações</p>
<strong>Espaço:</strong> Na sala de estimulação  os bebês, com toda segurança, podem explorar o espaço. Através do uso de  tatames, espelho e brinquedos apropriados os bebês desenvolvem-se ao olhar de  duas cuidadosas berçaristas.</p>
