    ...
    <div id="content">
        <div id="menu">
			...
			if($_SESSION['login'] == session_id() && $_SESSION['tipoUsuario'] == "funcionario"){
				...
				case "admin":
					?><a href="contato.php">Contato</a> | <a href="assunto.php">Assunto</a> | <a href="cadastro.php">Cadastro</a> | <a href="turma.php">Turma</a> | <a href="tipoFuncionario.php">Tipo de Funcionário</a> | <a href="agenda.php">Agenda OnLine</a> | <a href="lista.php">Lista de Materiais</a><?PHP
					break;
				case "secretaria":
					?><a href="contato.php">Contato</a> | <a href="cadastro.php">Cadastro</a> | <a href="agenda.php">Agenda OnLine</a> | <a href="lista.php">Lista de Materiais</a><?PHP
					break;
				case "professor":
				...
				?> | <a href="alterarSenha.php">Alterar senha</a> | <a href="sair.php">Sair</a><?PHP
			}else{
				?>Faça o login<?PHP
			}
			?>
